...
## Modelo 2 - testando se eu remover as variáveis sem significancias se aumenta a precisão
# o que se mostrou ineficinente que mesmo com a correlação menor a acurácia reduziu

modelo2 <- lm(gastos ~ idade + filhos + bmi + fumante, data = despesas)
summary(modelo2)
...
# valida se o cara é consideredo obeso
