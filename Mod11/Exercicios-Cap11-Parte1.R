...
modelo_idade_tempo <- lm(Idade~Tempo)

# Calcule a reta de regressão

plot(Idade,Tempo)
abline(modelo_idade_tempo)
...
modelo_altura_peso <- lm(alturas~pesos)

# Visualizando o modelo
summary(modelo_altura_peso)
...
previsao_altura_peso <- predict(modelo_altura_peso, alturas2)
summary(previsao_altura_peso)
View(previsao_altura_peso)
